...
BELANGRIJK: deze versie behoudt de lege spacer-alinea's (witruimte) die in
het sjabloon tussen structuurelementen staan (bv. na een verdiepingsniveau,
na een ruimtenaam, na het laatste bullet-item van een Contenant/Contenu-blok).
Zonder dit zou de output-lay-out compacter zijn dan het sjabloon.
"""
